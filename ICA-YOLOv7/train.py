...
if __name__ == "__main__":
    ...
    if local_rank == 0:
        ...
        if total_step <= wanted_step:
            ...
            print("\n\033[1;33;44m[Warning] when using optimizer %s, step should be over %d \033[0m"%(optimizer_type, wanted_step))
            print("\033[1;33;44m[Warning] dataset amount %d，Unfreeze_batch_size %d, train %d Epoch，get all step %d。\033[0m"%(num_train, Unfreeze_batch_size, UnFreeze_Epoch, total_step))
            print("\033[1;33;44m[Warning] total step is %d, wanted step is %d, wanted epoch is %d。\033[0m"%(total_step, wanted_step, wanted_epoch))
