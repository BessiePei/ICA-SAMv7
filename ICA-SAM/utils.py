...
def get_boxes_from_mask(mask, mask_path, box_num=1, std = 0.1, max_pixel = 5):
    """
    Args:
    ...
    elif len(boxes) < box_num and len(boxes) > 0:
    ...
    for box in boxes:
        ...
        max_noise = min(max_pixel, int(noise_std * 10))
...
def train_transforms(img_size, ori_h, ori_w, resize_type):
    transforms = []
    ...
    if resize_type == "nearest":
        ...
        print("we do not support this reszie_type")
    # ---------------end my change -------------
